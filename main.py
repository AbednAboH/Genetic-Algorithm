...
def main():
    ...
    solution=None
    if alg == GenA:
        problem_set = problem_sets_GA[int(input("choose problem to solve :  1:Bul Pgia  2:N Queens "))]
        ...
        solution=algo[alg](GA_TARGET,target_size,GA_POPSIZE,problem_set,crosstype,fit,selection,serviving_stratigy)
    elif alg == PSO:
